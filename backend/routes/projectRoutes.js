...
import { addProject, updateProject, deleteProject, getAllProjects, searchProject } from '../controllers/projectController.js'
...
projectRoutes.get("/search-project/:query", searchProject);
